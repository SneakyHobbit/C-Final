...
// addMagicWord()
//
// adds a MagicWord instance pointer to the Player's
// vector of MagicWord instance pointers
//
// returns the number of MagicWords in the vector
//***********************************************************
int Player::addMagicWord(MagicWord* pMW)
{
    int n = Container::addMagicWord(pMW);

    // update Player points
    m_points += pMW->getPoints();
...
//  3) take away Player MagicWord points
//  4) return pointer to MagicWord taken from Player or nullptr
//***********************************************************
MagicWord* Player::removeMagicWord()
{
    MagicWord* pMW = Container::removeMagicWord();
